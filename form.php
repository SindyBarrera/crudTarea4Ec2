<div class="box box-primary">
    ...
    ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="movil" id="movil" class="form-control" placeholder="0000-0000" value="<?php echo $telefono?>" required="true">
        </div>
        <div class="form-group">
            <label for="">Correo electronico:</label>
            <input type="email" name="email" id="email" class="form-control" placeholder="xxxx..@gmail.com" value="<?php echo $correo?>" required="true">
        </div>

        <div class="form-group">
            <label for="">DPI:</label>
            <input type="text" name="dpi" id="dpi" class="form-control" placeholder="XXXX-XXXXX-XXXX" value="<?php echo $dpi?>" required="true">
        </div>
        ...
        <div class="form-group">
            ...
            <button type="button" class="btn btn-primary" onclick="location.href='<?= site_url('alumnosController/') ?>'">
